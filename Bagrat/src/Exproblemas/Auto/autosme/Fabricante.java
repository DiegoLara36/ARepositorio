...
public class Fabricante {
    ...
    public Fabricante(String nombre){
        ...
        this.nombre=nombre;
        autos= new LinkedHashMap<>();//orden aleatorio
    }
    ...
    public void ValidarNoeExistaNIV(Auto auto){
        ...
        //es la iteracion para aplicar map.entry
        for(Map.Entry<String,Set<Auto>> mapa: autos.entrySet()){
            //si el valor del key (set.getvalue) contiene el objeto auto
            //retorna error "ya lo tiene en la "lista""
            if (mapa.getValue().contains(auto)) {
                //si algun elemnto del mapa, y de estos del conjunto contiene auto, devolver throw
    ...
    public void anadeModelo(String modelo){
        ...
        //crea la key modelo pero con su valor nulo
