...
public class EjecutaJobCandidate2 {
    ...
    public static void main(String[] args) {
        ...
        Collections.sort(jobCandidateslista,JobCandidate.ageComparator);
  ...
  */
        ...
        Collections.sort(jobCandidateslista,JobCandidate.nameComparator);
        //ORDENA SGUN LOS NOMBRES CTV
        System.out.println("..................despues de ordenar(por nombres).............");
        for(JobCandidate s: jobCandidateslista){
            System.out.println(s);
        }
